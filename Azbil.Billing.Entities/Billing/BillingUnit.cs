...
namespace Azbil.Billing.Entities.Billing
{
    ...
    public partial class BillingUnit : IEntity
    {
       // [Required]
       [Key]
        ...
        public int C_CstId { get; set; }
        public int C_BlockId { get; set; }
        public string BillingUnitStatus { get; set; }
        public int InsertedUserId { get; set; }
        public System.DateTime InsertedDateTime { get; set; }

        public virtual ICollection<MinOffTake> MinOffTakes { get; set; }
    }
}
